...
public class PipelineProcessB implements Runnable
{
	...
	// memory' error.
	public Mat mat;// = new Mat(120, 160, CvType.CV_8UC3);
	...
	public int cameraWidth;// = 160;
	public int cameraHeight;// = 120;
	public String cameraName;// = "Turret Camera";

	public VideoSource camera;
	public CameraProcessB cameraProcess;

	protected PipelineProcessB(CameraProcessB cameraProcess, VisionInit.CameraConfig cameraConfig)
	{
	...
	public void run()
	{
		...
		if (VisionInit.displayTurretContours)
		{
		...
		while (!Thread.interrupted())
		{
			...
			// Call the process() method that was created by the user to process the camera frame.
		...
		// TODO: at this point the target data is in currentTargetData
		// TODO: at this point the target data is in currentTargetData
		// TODO: at this point the target data is in currentTargetData
		// TODO: at this point the target data is in currentTargetData
		// TODO: at this point the target data is in currentTargetData
